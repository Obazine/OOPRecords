...
static void AllStudents(StudentRepository students)
{
    ConsolePlus.WriteList(students.AllStudents(), "\n");
}

static void FindStudent(StudentRepository students)
{
...
static void CreateStudent(StudentRepository students)
{
